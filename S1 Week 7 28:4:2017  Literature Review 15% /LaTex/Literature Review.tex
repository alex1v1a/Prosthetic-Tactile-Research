...
This is a critical move in applying using a tactile device to output in micro volts and stimulate the nerve sense with the TMR mapping. It is hoped to re-obtain some of the lost sense back; this could be applied for machines, and patients with nerve damage not just amputees. It also open the possibility in assistive touch for those suffering from muscle diseases such as ALS, in the respect that in collaboration with another device a computer is able to assist the user in not over-gripping/under-gripping of objects etc.
